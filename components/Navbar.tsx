    ...
    <>
      ...
      >
        ...
        <div className="flex flex-row space-x-10 bg-neutral-400/20 rounded-2xl px-10 py-5">
          <Link href="/cart">
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="icon icon-tabler icons-tabler-filled icon-tabler-shopping-cart dark:text-white dark:active:text-blue-500 active:text-blue-500"
            >
          ...
          <Link href="/login">
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="icon icon-tabler icons-tabler-filled icon-tabler-heart dark:text-white dark:active:text-pink-500 active:text-pink-500"
            >
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <motion.div
          ...
          layout
          className="flex items-center rounded-2xl px-4 py-5"
        >
          <ThemeToggleButton2 className="h-5 w-5 bg-transparent" />
